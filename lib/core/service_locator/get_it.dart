...
import 'package:tasks_demo_flutter/features/tasks_crud/data/repository/task_repository_firestore.dart';
...
class ServiceLocatorGetIt {
  ...
  static void setupLocator() {
    ...
    getIt.registerFactory<TaskRepositoryInterface>(() => TaskRepositoryFirestore());
    getIt.registerFactory<AuthenticatonInterface>(() => FirebaseAuthentication());
  }
}